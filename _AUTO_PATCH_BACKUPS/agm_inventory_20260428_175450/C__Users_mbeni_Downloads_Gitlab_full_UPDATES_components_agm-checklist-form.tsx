"use client"
import AgmInventoryPanel from "@/components/agm-inventory-panel"
  ...
  return (
    <div className="min-h-screen bg-background p-4 md:p-8">
      <div className="mx-auto max-w-4xl">
        ...
        {/* Progress */}
        <formProgress currentStep={currentStep} totalSteps={steps.length} stepLabels={steps.map(s =>

{/* AUTO-PATCH: AGM inventory upload + display */}
<AgmInventoryPanel /> s.title)} />
