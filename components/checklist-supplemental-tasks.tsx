...
type ChecklistSupplementalTasksProps = {
  checklistType: "pm" | "night"
}

export function ChecklistSupplementalTasks({ checklistType }: ChecklistSupplementalTasksProps) {
  ...
  const labelPrefix = checklistType === "pm" ? "PM" : "Night Audit"
  const idPrefix = checklistType === "pm" ? "pm" : "night"
  ...
  useEffect(() => {
    ...
    container.setAttribute("data-checklist-supplemental-tasks", checklistType)
  ...
  const content = useMemo(() => (
    <ChecklistSection
      title={`${labelPrefix} Deposits, Incidentals, and GXP/GPS Standards`}
      description="Complete deposit processing, prepare incidental folios, and review GXP/GPS follow-up before handoff."
    >
      ...
      <ChecklistTask
        id={`${idPrefix}CollectBatchDeposits`}
      ...
      <ChecklistTask
        id={`${idPrefix}CollectDayOfDeposits`}
      ...
      <ChecklistTask
        id={`${idPrefix}ReviewGxpGpsStandards`}
  ...
  ), [batchDepositsCollected, dayOfDepositsPrepared, gxpGpsReviewed, idPrefix, labelPrefix])
