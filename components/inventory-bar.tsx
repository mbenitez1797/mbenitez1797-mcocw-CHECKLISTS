    ...
    <div className={cn(
      ...
      <div className="flex flex-col">
        ...
        <div className="flex items-baseline gap-2">
          <span className={cn("text-2xl font-bold tabular-nums", value < 0 ? "text-red-300" : "text-white")}>{value}</span>
      ...
      <div className="px-4 py-3">
        ...
        <div className="flex items-center gap-3">
          ...
          <InventoryStat
            label="VIQN"
            value={viqnTotal}
            tomorrowValue={tomorrowViqnTotal}
            showTomorrow={showTomorrow}
            icon={<BedDouble className="w-5 h-5 text-cyan-400" />}
            colorClass="bg-cyan-500/20 border-cyan-500/30"
          />
          ...
          <div className="ml-auto flex items-center gap-3 px-4 py-2 rounded-lg bg-white/5 border border-white/10">
            ...
            <span className="text-3xl font-bold text-white tabular-nums">
              {kingTotal + queensTotal + vikgTotal + viqnTotal + suitesTotal}
            </span>
          </div>
