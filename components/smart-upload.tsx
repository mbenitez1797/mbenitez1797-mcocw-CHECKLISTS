...
const MOCK_DEPARTURES = 25
const MOCK_STAYOVERS = 64
    ...
    <div className="bg-gradient-to-br from-indigo-50 to-purple-50 border-2 border-indigo-200 rounded-xl p-6 mb-6">
      ...
      <div className="flex items-center gap-3 mb-4">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">AI-powered daily KPI scanner</p>
        </div>
      </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="text-sm text-muted-foreground">
            ...
            <ol className="list-decimal list-inside space-y-1">
              ...
              <li>Use Room Availability or manual entry below for room-type buckets</li>
        ...
        <div className="space-y-4">
          ...
          {isProcessing && (
            <div className="bg-indigo-50 border border-indigo-200 rounded-lg p-4 text-center">
              ...
              <p className="text-sm text-indigo-500 mt-1">Analyzing screenshot for daily KPI data</p>
            </div>
          )}
          ...
          {extractionComplete && extractedData && (
            <div className="bg-green-50 border border-green-200 rounded-lg p-4">
              ...
              <div className="rounded-lg border border-amber-200 bg-amber-50 p-3 text-sm text-amber-800">
                Room-type buckets are not calculated from this upload. Use the Room Availability report or manual room-code entry for KING, QNQN, VIQN, VIKG, and SUIT availability.
              </div>

              <p className="text-sm text-green-600 mt-3 text-center">
                Daily KPI data has been updated. Room bucket values below were not changed.
              </p>
